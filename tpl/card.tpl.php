...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.objecthistory.write;noerr]=1]
	
		[onshow;block=begin;when [object.status]=[ObjectHistory.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[ObjectHistory.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[ObjectHistory.STATUS_REFUSED]]
