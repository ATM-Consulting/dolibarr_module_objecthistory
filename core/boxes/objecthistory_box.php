 ...
 */
class objecthistorybox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "objecthistory@objecthistory";
    public $boxlabel;
    public $depends = array("objecthistory");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/objecthistory/class/objecthistory.class.php";
