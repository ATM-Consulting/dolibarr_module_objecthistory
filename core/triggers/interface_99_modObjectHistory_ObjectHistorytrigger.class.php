...
/**
 * 	\file		core/triggers/interface_99_modMyodule_ObjectHistorytrigger.class.php
 * 	\ingroup	objecthistory
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modObjecthistory_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceObjectHistorytrigger
{
